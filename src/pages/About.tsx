      ...
      <div className="page-content" style={{ maxWidth: 720, paddingBottom: '5rem' }}>
        ...
        <section style={{ marginBottom: '2.5rem' }}>
          <p style={{ color: 'var(--text-secondary)', lineHeight: 1.75, fontSize: '1rem' }}>
            Vadai is a beautifully crafted streaming interface for Tamil, Hindi, and Malayalam
        ...
        <section style={{ marginBottom: '2.5rem' }}>
          ...
          <p style={{ color: 'var(--text-secondary)', lineHeight: 1.75 }}>
            Vadai is a front-end interface. It does not host or store any video files — streams
        ...
        <section style={{ marginBottom: '2.5rem' }}>
          ...
          <p style={{ color: 'var(--text-secondary)', lineHeight: 1.75 }}>
            Add Vadai to your home screen for a full-screen, native-feeling experience.
        ...
        <section style={{ marginBottom: '2.5rem' }}>
          ...
          <p style={{ color: 'var(--text-secondary)', lineHeight: 1.75 }}>
            Vadai stores your watchlist, continue-watching progress, and profile preferences
